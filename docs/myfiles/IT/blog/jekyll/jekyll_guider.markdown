...
1.  [jekyll-gitbook github链接以及教程](https://github.com/sighingnow/jekyll-gitbook)
2. [jekyll官网](https://www.jekyll.com.cn/)
3. [为 Markdown 生成 TOC 的 Vim 插件](https://cloud.tencent.com/developer/article/1964694)
4. [Jekyll 生成文章目录树配置](http://www.yuyanba.com/default.aspx/did21122)
